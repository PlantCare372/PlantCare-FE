...
class _NextScreen extends State<NextScreen> {
  ...
  Future fetchData() async {
    Response res = await get(Uri.parse('http://178.128.127.43/api/v1/users/get-favorited-plants'),
                  ...
                  child: Column(
                    children: <Widget>[
                      Container(
                        ...
                        height: 90,
                        child: fav[index]['image'] == null
                            ? Image.asset('assets/images/blank-tree.png')
                            : fav[index]['image'],
                      ),
                      GestureDetector(
                        onTap: () {
                            ...
                            children: <Widget>[
                              Column(
                                children: <Widget>[
                                  ...
                                  Text(
                                    fav[index]['country'] == null
                                        ? 'No country found'
                                        : fav[index]['country'].toString(),
